...
def parser():
    ...
    parser.add_argument('--lambda_EMR', type=float, default=100.0,
        help='the parameter of l2 restriction for logit_grad_norm')
    parser.add_argument('--EMR_decay', type=float, default=0.1,
        help='decay EMR')
    parser.add_argument('--EMR_softmax_temp', type=float, default=0.1,
        help='temperature in EMR')
