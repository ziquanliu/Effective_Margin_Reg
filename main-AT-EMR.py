...
class Trainer():
    ...
    def train(self, model, tr_loader, va_loader=None, adv_train=False):
        ...
        scheduler = torch.optim.lr_scheduler.MultiStepLR(opt, 
                                                         milestones=[iter_per_epoch*60, iter_per_epoch*90], 
                                                         gamma=0.1)
        _iter = 0
        ...
        for epoch in range(1, args.max_epoch+1):
            ...
            for data, label in tr_loader:
                ...
                opt.zero_grad()
                #loss.backward()
                # regularization for logit gradient norm
                ...
                #print(prob_logit)
                # test
                #test_grad = torch.autograd.grad(output_eval[0,0],adv_data)[0]
                #print(test_grad[1,:,:,:].sum())
